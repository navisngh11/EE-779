...
% approximation of training image, the error is quite low. Also the
...
%% Q4 and Q5
% With only 100 principal components
facerecog2_navjot
%% 
...
% Instead of calculating eigenvectors of XX', they calculated eigenvectors
