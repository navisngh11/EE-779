% Author : Navjot Singh (130110071)
% Plot for Ques2 in Written Assignment
clear all
close all
...
ylabel('|W(\theta)|.^2')
title('Plots for Ques2 (Written Assignment) \theta0 = 45 degree and \theta0 = 90 degree');
xlabel('Angle (degree)')
set(gcf, 'Position', get(0, 'Screensize'));
legend('45 degree', '90 degree');
saveas(fig,'./html/Plots_written_Q2.jpg','jpg');
